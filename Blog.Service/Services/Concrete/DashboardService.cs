...
namespace Blog.Service.Services.Concrete
{
    public class DashboardService :IDashboardService
    {
        ...
        public async Task<List<int>> GetYearlyArticleCounts()
        {
            ...
            startDate=new DateTime(startDate.Year,1,1); //içinde bulunduğum yılın 1. ayının 1. gününü alıyorum sene başından beri istatistik tuttuğumdan
            ...
            return datas; //hangi ayda kaç tane makale oluşturduğumu liste tipinde bana dönecek
        }
